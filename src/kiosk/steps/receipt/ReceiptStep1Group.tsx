...
interface ReceiptStep1GroupProps {
...
/**
 * Receipt Kiosk Flow — Step 1: Select Group/Event.
 *
 * If no groups exist in IndexedDB, shows an admin message and disables forward
 * navigation (Requirement 7.6).
 *
 * Validates: Requirements 7.1, 7.6, 9.4, 9.5
 */
export function ReceiptStep1Group({ draft, onNext, onBack, isLoading }: ReceiptStep1GroupProps) {
